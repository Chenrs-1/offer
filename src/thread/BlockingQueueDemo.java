...
public class BlockingQueueDemo {
    public static void main(String[] args) throws InterruptedException {
        //List list = new ArrayList();//默认值10，可以不用写
        BlockingQueue<String> blockingQueue = new ArrayBlockingQueue<String>(3);//必须写个初始值
    ...
    private static void outOfTime(BlockingQueue<String> blockingQueue) throws InterruptedException {
        System.out.println(blockingQueue.offer("a",2L, TimeUnit.SECONDS));//两秒钟放不进去，就撤了
    ...
    private static void addAndRemove(BlockingQueue<String> blockingQueue) {
        ...
        System.out.println(blockingQueue.remove());//remove没有写参数，队列先进先出
